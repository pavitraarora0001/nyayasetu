...
function uploadConstitution() {
    return __awaiter(this, void 0, void 0, function () {
        var filePath, uploadResponse, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    filePath = path_1.default.resolve(process.cwd(), "constitution of India.pdf");
                    console.log("\uD83D\uDCE4 Uploading: ".concat(filePath, "..."));
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, fileManager.uploadFile(filePath, {
                ...
                case 2:
                    ...
                    console.log("---------------------------------------------------");
                    console.log("FILE URI: ".concat(uploadResponse.file.uri));
                    console.log("---------------------------------------------------");
                    console.log("\n\uD83D\uDC47 ACTION REQUIRED:");
                    console.log("Add this line to your .env file to enable global access:");
                    console.log("LEGAL_PDF_URI=".concat(uploadResponse.file.uri));
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _a.sent();
